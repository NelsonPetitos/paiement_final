                    ...
                    <div class="wearetechmodal" style="margin-top:50px;">
                        <div style="text-align:center;background:#e8e9eb;border-top-left-radius:5px;border-top-right-radius:5px;padding:10px 15px 10px 15px;">
                            <div style="width:100%;text-align:center;padding-top:40px;">
                                ...
                                <h1 class="Header-companyName">DoYouBiz</h1>
                                <h2 class="Header-purchaseDescription">Valider le paiement de : ${request.params.id}</h2>
                            </div>
                        </div>
                        <div style="background:#f5f5f5;padding:10px 30px 10px 30px;border-top:1px solid silver;border-top-left-radius:5px;border-top-right-radius:5px;">
                            <div style="margin-top:20px;">
                                <div>
                                    <select id="country_code">
                                        <option value="" style="">Cameroun +237</option>
                                ...
                                <div style="">
                                    <span>
                                        <title>Flag</title>
                                        <svg xmlns="http://www.w3.org/2000/svg" style="width: 17px;margin-left:6px;position:relative;top:-27px;margin-bottom:-30px;" focusable="false" fill="#489cfd"  viewBox="0 0 60 60" version="1.1" id="Capa_1" x="0px" y="0px">
                            ...
                            <div style="margin-top:20px;">
                                <div style="margin-bottom:0px;">
                                    <input id='wearetech_client_email' style="width:100%;border:none;height:38px;padding-left:35px;padding-right:5px;font-size:13px;border-top-left-radius:5px;border-top-right-radius:5px;border:1px solid rgba(0,0,0,0.15);margin-bottom:0px;" placeholder="Email" type="email">
                                </div>
                                <div style="">
                                    <span>
                                        <title>Email</title>
                                        <svg xmlns="http://www.w3.org/2000/svg" style="width: 35px;margin-left:6px;position:relative;top:-28px;margin-bottom:-37px;" focusable="false" fill="#489cfd"  viewBox="0 0 60 60" version="1.1" id="Capa_1" x="0px" y="0px">
                                ...
                                <div style="margin-top:0px;">
                                    <input id='wearetech_phone_number' style="width:100%;border:none;padding-left:35px;padding-right:5px;height:38px;font-size:13px;border-bottom-left-radius:5px;border-bottom-right-radius:5px;border:1px solid rgba(0,0,0,0.15);margin-top:0px;" type="number" placeholder="Téléphone">
                                </div>
                                <div style="">
                                    <span>
                                        <title>Phone</title>
                                        <svg xmlns="http://www.w3.org/2000/svg" style="width: 40px;margin-left:6px;position:relative;top:-28px;margin-bottom:-40px;" focusable="false" fill="#489cfd"  viewBox="0 0 60 60" version="1.1" id="Capa_1" x="0px" y="0px">
                            ...
                            <div style="margin-top:20px;">
                                <button style="" class="checkout">Payer ${request.params.id} Fcfa</button>
                            </div>
                        </div>
                    </div>
                </div>
